...
const OUTCOME_LABEL: Record<string, { label: string; color: string }> = {
  ...
  VOICEMAIL:            { label: '📧 Voicemail left',    color: 'bg-amber-100 text-amber-800 border-amber-200' },
  BUSY_OR_DISCONNECTED: { label: '📵 Busy / disconnected', color: 'bg-amber-100 text-amber-800 border-amber-200' },
  WRONG_NUMBER:         { label: '❌ Wrong number',      color: 'bg-amber-100 text-amber-800 border-amber-200' },
  INVALID_CONTACT_INFO: { label: '⚠️ Bad contact info',  color: 'bg-amber-100 text-amber-800 border-amber-200' },
