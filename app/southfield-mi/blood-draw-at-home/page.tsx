...
export default function SouthfieldBloodDrawAtHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="southfield-mi" cityShort="Southfield" variant="blood-draw-at-home" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Blood Draw at Home in Southfield, MI</h1>
          <p className="text-xl text-primary-100">Professional blood draw at home in Southfield — request same-day or next-day availability.</p>
        </div>
      </div>
