...
export default function DearbornInHomeBloodDraw() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="dearborn-mi" cityShort="Dearborn" variant="in-home-blood-draw" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">In-Home Blood Draw Services in Dearborn, MI</h1>
          <p className="text-xl text-primary-100">Professional in-home blood draw services in Dearborn — request same-day or next-day availability.</p>
        </div>
      </div>
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <h2 className="text-2xl font-bold mb-4">About In-Home Blood Draw Services in Dearborn</h2>
        ...
        <CityFAQ cityName="Dearborn, MI" cityShort="Dearborn" variant="in-home-blood-draw" />

        <CityIntentVariantLinks citySlug="dearborn-mi" cityName="Dearborn, MI" current="in-home-blood-draw" />
      </div>
