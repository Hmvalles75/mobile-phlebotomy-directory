...
export default function DearbornMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="dearborn-mi" cityShort="Dearborn" variant="mobile-phlebotomy" />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <CityIntentVariantLinks citySlug="dearborn-mi" cityName="Dearborn, MI" current="mobile-phlebotomy" />
      </div>
