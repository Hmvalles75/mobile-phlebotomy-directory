...
export default function CityPageClient({ params, initialProviders, initialGrouped }: CityPageClientProps) {
  ...
  // (provider fetch removed — the server now supplies them as props)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            {/* Rendered only when there is a real count. This heading used to
