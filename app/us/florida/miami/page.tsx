...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://mobilephlebotomy.org/us/florida/miami",
  },
  openGraph: {
    title: "Mobile Phlebotomy Miami: 30 Vetted Providers (2026)",
    description: "Find mobile phlebotomy in Miami, FL. 30 vetted providers serving the Miami area — Lab Specimen Collection, Urinalysis Collection, Blood Draw. Typical service fee $65–$130 per visit. Same-day appointments available.",
    url: "https://mobilephlebotomy.org/us/florida/miami",
    type: 'website',
  },
}

const localBusinessSchema = {"@context":"https://schema.org","@type":"MedicalBusiness","name":"Mobile Phlebotomy in Miami, FL","description":"Directory of vetted mobile phlebotomists serving Miami, Florida and surrounding areas.","url":"https://mobilephlebotomy.org/us/florida/miami","areaServed":{"@type":"City","name":"Miami","containedInPlace":{"@type":"State","name":"Florida"}},"priceRange":"$65–$130","medicalSpecialty":"Phlebotomy"}
