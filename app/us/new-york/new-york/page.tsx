...
export default async function NewYorkMobilePhlebotomyPage() {
  const [seoProviders, nearbyCities] = await Promise.all([
    getProvidersForCity("new-york", "NY"),
    getNearbyCities("new-york", "NY", 8),
  ])
    ...
    <>
      ...
      <div className="bg-gray-50">
        <div className="container mx-auto px-4 pb-12">
          <ProvidersInCity providers={seoProviders} cityName={"New York"} stateAbbr={"NY"} />
          <NearbyCities
            cities={nearbyCities}
            sourceCitySlug={"new-york"}
            sourceCityName={"New York"}
            sourceStateName={"New York"}
          />
        </div>
      </div>
    </>
