...
export default function GlendaleMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="glendale-ca" cityShort="Glendale" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Glendale, CA</h1>
          <p className="text-xl text-primary-100">Professional at-home blood draw services in Glendale — request same-day or next-day availability.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Glendale + Los Angeles Metro
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Glendale and the greater Los Angeles metro area.
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">📍</span>
                <span className="font-bold text-gray-900">Los Angeles</span>
              </div>
              <span className="text-sm text-gray-600 group-hover:text-primary-600">View providers →</span>
            </Link>
          </div>
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Glendale, CA" variant="compact" />
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700">Licensed phlebotomists come to your Glendale location for convenient blood draws. Same-day and next-day appointments typically available.</p>
        </div>

        <CityFAQ cityName="Glendale, CA" cityShort="Glendale" variant="mobile-phlebotomy" />

        <CityIntentVariantLinks citySlug="glendale-ca" cityName="Glendale, CA" current="mobile-phlebotomy" />
      </div>
      <LeadFormModal isOpen={leadFormOpen} onClose={() => setLeadFormOpen(false)} defaultCity="Glendale" defaultState="CA" defaultZip="" />
    </div>
  )
}
