...
export default function BrooklynBloodDrawAtHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="brooklyn-ny" cityShort="Brooklyn" variant="blood-draw-at-home" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Blood Draw at Home in Brooklyn, NY</h1>
          <p className="text-xl text-primary-100">Professional blood draw at home in Brooklyn — request same-day or next-day availability.</p>
        </div>
      </div>
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <h2 className="text-2xl font-bold mb-4">About Blood Draw at Home in Brooklyn</h2>
        ...
        <CityFAQ cityName="Brooklyn, NY" cityShort="Brooklyn" variant="blood-draw-at-home" />

        <CityIntentVariantLinks citySlug="brooklyn-ny" cityName="Brooklyn, NY" current="blood-draw-at-home" />
      </div>
