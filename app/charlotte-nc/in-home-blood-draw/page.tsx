...
export default function CharlotteInHomeBloodDraw() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="charlotte-nc" cityShort="Charlotte" variant="in-home-blood-draw" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">In-Home Blood Draw Services in Charlotte, NC</h1>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <CityFAQ cityName="Charlotte, NC" cityShort="Charlotte" variant="in-home-blood-draw" />

        <CityIntentVariantLinks citySlug="charlotte-nc" cityName="Charlotte, NC" current="in-home-blood-draw" />
      </div>
