...
export default function BostonMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="boston-ma" cityShort="Boston" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Boston, MA</h1>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">Boston is one of the world&apos;s leading medical hubs — home to Mass General, Brigham and Women&apos;s, Beth Israel Deaconess, Tufts Medical, and the Longwood Medical Area cluster. Despite that density, many patients in high-rise apartments, Back Bay brownstones, and the ring of commuter suburbs (Cambridge, Somerville, Brookline, Newton, Quincy) still struggle to reach a lab during business hours.</p>
        ...
        <CityFAQ cityName="Boston, MA" cityShort="Boston" variant="mobile-phlebotomy" />
