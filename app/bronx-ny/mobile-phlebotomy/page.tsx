...
export default function BronxMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="bronx-ny" cityShort="Bronx" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Bronx, NY</h1>
          <p className="text-xl text-primary-100">At-home blood draw services in Bronx — request same-day or next-day availability when scheduling allows.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Bronx + All NYC Boroughs
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Bronx and all five NYC boroughs.
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600 mb-3">
              <strong>Neighborhoods served in Bronx:</strong> Riverdale, Fordham, Pelham Bay, Parkchester, Mott Haven
            </p>
            <button
              onClick={() => {
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Bronx, NY" variant="compact" />
            </div>
          </div>
        )}
