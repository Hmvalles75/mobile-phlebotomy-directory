...
export default function StatenIslandMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="staten-island-ny" cityShort="Staten Island" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Staten Island, NY</h1>
          <p className="text-xl text-primary-100">At-home blood draw services in Staten Island — request same-day or next-day availability when scheduling allows.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Staten Island + All NYC Boroughs
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Staten Island and all five NYC boroughs.
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600 mb-3">
              <strong>Neighborhoods served in Staten Island:</strong> St. George, Tottenville, New Springville, Great Kills, Port Richmond
            </p>
            <button
              onClick={() => {
            ...
            >
              📋 Request Service in Staten Island
            </button>
          </div>
        </div>
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 p-4 border-b border-amber-200">
              <div className="flex items-center mb-2">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                  ...
                  Featured Provider in Staten Island
                </h2>
              </div>
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Staten Island, NY" variant="compact" />
            </div>
          </div>
        )}
