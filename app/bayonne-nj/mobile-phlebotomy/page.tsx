...
export default function BayonneMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="bayonne-nj" cityShort="Bayonne" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Bayonne, NJ</h1>
          <p className="text-xl text-primary-100">At-home blood draw services in Bayonne — request same-day or next-day availability when scheduling allows.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Bayonne + NYC Metro Area
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Bayonne and the greater NYC metro area including all five boroughs.
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Bayonne, NJ" variant="compact" />
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700">Licensed phlebotomists come to your Bayonne location for convenient blood draws. Same-day and next-day appointments typically available when scheduling allows.</p>
        </div>

        <CityFAQ cityName="Bayonne, NJ" cityShort="Bayonne" variant="mobile-phlebotomy" />

        <CityIntentVariantLinks citySlug="bayonne-nj" cityName="Bayonne, NJ" current="mobile-phlebotomy" />
      </div>
