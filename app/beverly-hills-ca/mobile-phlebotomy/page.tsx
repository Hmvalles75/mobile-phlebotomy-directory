...
export default function BeverlyHillsMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="beverly-hills-ca" cityShort="Beverly Hills" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Beverly Hills, CA</h1>
          <p className="text-xl text-primary-100">Professional at-home blood draw services in Beverly Hills — request same-day or next-day availability.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Beverly Hills + Los Angeles Metro
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Beverly Hills and the greater Los Angeles metro area.
          ...
          <div className="pt-4 border-t border-gray-200">
            ...
            >
              📋 Request Service in Beverly Hills
            </button>
          </div>
        </div>
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 p-4 border-b border-amber-200">
              <div className="flex items-center mb-2">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                  ...
                  Featured Provider in Beverly Hills
                </h2>
              </div>
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Beverly Hills, CA" variant="compact" />
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700">Licensed phlebotomists come to your Beverly Hills location for convenient blood draws. Same-day and next-day appointments typically available.</p>
        </div>

        <CityFAQ cityName="Beverly Hills, CA" cityShort="Beverly Hills" variant="mobile-phlebotomy" />

        <CityIntentVariantLinks citySlug="beverly-hills-ca" cityName="Beverly Hills, CA" current="mobile-phlebotomy" />
      </div>
      <LeadFormModal isOpen={leadFormOpen} onClose={() => setLeadFormOpen(false)} defaultCity="Beverly Hills" defaultState="CA" defaultZip="" />
    </div>
  )
}
