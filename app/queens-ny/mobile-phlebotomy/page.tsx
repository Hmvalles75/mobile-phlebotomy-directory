...
export default function QueensMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="queens-ny" cityShort="Queens" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Queens, NY</h1>
          <p className="text-xl text-primary-100">At-home blood draw services in Queens — request same-day or next-day availability when scheduling allows.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Queens + All NYC Boroughs
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Queens and all five NYC boroughs.
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600 mb-3">
              <strong>Neighborhoods served in Queens:</strong> Astoria, Flushing, Long Island City, Forest Hills, Jamaica
            </p>
            <button
              onClick={() => {
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Queens, NY" variant="compact" />
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700">Licensed phlebotomists come to your Queens location for convenient blood draws. Same-day and next-day appointments typically available when scheduling allows.</p>
        </div>

        <CityFAQ cityName="Queens, NY" cityShort="Queens" variant="mobile-phlebotomy" />

        <CityIntentVariantLinks citySlug="queens-ny" cityName="Queens, NY" current="mobile-phlebotomy" />
      </div>
      <LeadFormModal isOpen={leadFormOpen} onClose={() => setLeadFormOpen(false)} defaultCity="Queens" defaultState="NY" defaultZip="" />
    </div>
  )
}
