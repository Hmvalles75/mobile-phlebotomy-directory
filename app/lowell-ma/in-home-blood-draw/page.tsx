...
export default function LowellInHomeBloodDraw() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="lowell-ma" cityShort="Lowell" variant="in-home-blood-draw" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">In-Home Blood Draw Services in Lowell, MA</h1>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700 leading-relaxed">Licensed phlebotomists come to your Lowell-area location for convenient blood draws. Services include routine lab work, drug testing, wellness panels, and specialty collections. Same-day and next-day appointments are typically available throughout the greater Lowell metro area.</p>
        </div>

        <CityFAQ cityName="Lowell, MA" cityShort="Lowell" variant="in-home-blood-draw" />

        <CityIntentVariantLinks citySlug="lowell-ma" cityName="Lowell, MA" current="in-home-blood-draw" />
      </div>
