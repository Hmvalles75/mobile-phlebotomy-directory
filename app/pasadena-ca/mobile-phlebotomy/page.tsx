...
export default function PasadenaMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="pasadena-ca" cityShort="Pasadena" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Pasadena, CA</h1>
          <p className="text-xl text-primary-100">Professional at-home blood draw services in Pasadena — request same-day or next-day availability.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        {/* Serving Pasadena + LA Metro - INTERNAL LINKING HUB */}
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Pasadena + Los Angeles Metro
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Pasadena and the greater Los Angeles metro area.
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Pasadena, CA" variant="compact" />
            </div>
          </div>
        )}
