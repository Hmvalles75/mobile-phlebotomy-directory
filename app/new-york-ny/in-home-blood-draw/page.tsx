...
export default function NYCInHomeBloodDraw() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="new-york-ny" cityShort="New York" variant="in-home-blood-draw" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">In-Home Blood Draw Services in NYC</h1>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            In-Home Blood Draw Services in New York City
          </h2>
          <p className="text-gray-700 mb-6">
            Looking for in-home blood draw services in NYC? Browse our comprehensive directory of mobile phlebotomy providers serving all five boroughs.
          </p>
