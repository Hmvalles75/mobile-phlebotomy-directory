...
export default function MiamiBloodDrawAtHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="miami-fl" cityShort="Miami" variant="blood-draw-at-home" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Blood Draw at Home in Miami, FL</h1>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <CityFAQ cityName="Miami, FL" cityShort="Miami" variant="blood-draw-at-home" />

        <CityIntentVariantLinks citySlug="miami-fl" cityName="Miami, FL" current="blood-draw-at-home" />
      </div>
