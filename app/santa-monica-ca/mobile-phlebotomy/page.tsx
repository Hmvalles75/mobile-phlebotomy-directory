...
export default function SantaMonicaMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="santa-monica-ca" cityShort="Santa Monica" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Santa Monica, CA</h1>
          <p className="text-xl text-primary-100">Professional at-home blood draw services in Santa Monica — request same-day or next-day availability.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Santa Monica + Los Angeles Metro
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Santa Monica and the greater Los Angeles metro area.
          ...
          <div className="pt-4 border-t border-gray-200">
            ...
            >
              📋 Request Service in Santa Monica
            </button>
          </div>
        </div>
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 p-4 border-b border-amber-200">
              <div className="flex items-center mb-2">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                  ...
                  Featured Provider in Santa Monica
                </h2>
              </div>
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Santa Monica, CA" variant="compact" />
            </div>
          </div>
        )}
