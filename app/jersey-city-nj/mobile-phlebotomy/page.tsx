...
export default function JerseyCityMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="jersey-city-nj" cityShort="Jersey City" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Jersey City, NJ</h1>
          <p className="text-xl text-primary-100">At-home blood draw services in Jersey City — request same-day or next-day availability when scheduling allows.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Serving Jersey City + NYC Metro Area
          </h2>
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Jersey City and the greater NYC metro area including all five boroughs.
          ...
          <div className="pt-4 border-t border-gray-200">
            ...
            >
              📋 Request Service in Jersey City
            </button>
          </div>
        </div>
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 p-4 border-b border-amber-200">
              <div className="flex items-center mb-2">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                  ...
                  Featured Provider in Jersey City
                </h2>
              </div>
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Jersey City, NJ" variant="compact" />
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-700">Licensed phlebotomists come to your Jersey City location for convenient blood draws. Same-day and next-day appointments typically available when scheduling allows.</p>
        </div>

        <CityFAQ cityName="Jersey City, NJ" cityShort="Jersey City" variant="mobile-phlebotomy" />

        <CityIntentVariantLinks citySlug="jersey-city-nj" cityName="Jersey City, NJ" current="mobile-phlebotomy" />
      </div>
      <LeadFormModal isOpen={leadFormOpen} onClose={() => setLeadFormOpen(false)} defaultCity="Jersey City" defaultState="NJ" defaultZip="" />
    </div>
  )
}
