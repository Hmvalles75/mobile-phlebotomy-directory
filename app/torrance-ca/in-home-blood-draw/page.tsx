...
export default function TorranceInHomeBloodDraw() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="torrance-ca" cityShort="Torrance" variant="in-home-blood-draw" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">In-Home Blood Draw Services in Torrance, CA</h1>
          <p className="text-xl text-primary-100">Professional in-home blood draw services in Torrance — request same-day or next-day availability.</p>
        </div>
      </div>
