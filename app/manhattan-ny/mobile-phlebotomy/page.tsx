...
export default function ManhattanMobilePhlebotomy() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="manhattan-ny" cityShort="Manhattan" variant="mobile-phlebotomy" />
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">Mobile Phlebotomy in Manhattan, NY</h1>
          <p className="text-xl text-primary-100">At-home blood draw services in Manhattan — request same-day or next-day availability when scheduling allows.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-primary-100 p-8">
          ...
          <p className="text-gray-700 mb-6">
            Our network of mobile phlebotomists serves Manhattan and all five NYC boroughs.
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600 mb-3">
              <strong>Neighborhoods served in Manhattan:</strong> Midtown, Upper East Side, Lower Manhattan, Harlem, Chelsea
            </p>
            <button
              onClick={() => {
        ...
        {!loading && featuredProvider && (
          <div className="bg-white rounded-lg shadow-lg border-2 border-amber-300">
            <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-amber-100 p-4 border-b border-amber-200">
              <div className="flex items-center mb-2">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                  ...
                  Featured Provider in Manhattan
                </h2>
              </div>
            ...
            <div className="p-5 bg-gradient-to-r from-amber-50/40 to-transparent">
              ...
              <ProviderActions provider={featuredProvider} currentLocation="Manhattan, NY" variant="compact" />
            </div>
          </div>
        )}
        ...
        <CityFAQ cityName="Manhattan, NY" cityShort="Manhattan" variant="mobile-phlebotomy" />
