...
export default function LABloodDrawAtHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <CityBreadcrumb citySlug="los-angeles-ca" cityShort="Los Angeles" variant="blood-draw-at-home" />
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        ...
        <CityFAQ cityName="Los Angeles, CA" cityShort="Los Angeles" variant="blood-draw-at-home" />
      </div>
      <LeadFormModal
        isOpen={leadFormOpen}
