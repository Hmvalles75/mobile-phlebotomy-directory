...
export const topMetroAreas: MetroArea[] = [
  ...
  },
  {
    ...
    neighborhoods: ['Center City', 'University City', 'Old City', 'Fishtown', 'Manayunk', 'Chestnut Hill'],
    majorHospitals: ['Penn Medicine', 'Jefferson Health', 'Temple Health', 'Children\'s Hospital'],
    localInfo: {
      avgCost: '$70-140',
      typicalWaitTime: '24 hours',
      majorEmployers: ['Comcast', 'Independence Blue Cross', 'University of Pennsylvania', 'Merck', 'Vanguard']
    }
  },
  {
    rank: 7,
  ...
  },
  {
    ...
    stateAbbr: 'CA',
    population: 1021795,
    zipCodes: ['95101', '95110', '95111', '95112', '95113', '95116', '95117', '95118', '95119', '95120'],
    neighborhoods: ['Downtown', 'Willow Glen', 'Rose Garden', 'Almaden Valley', 'Evergreen', 'Berryessa'],
    majorHospitals: ['Stanford Health Care', 'Good Samaritan', 'Regional Medical Center', 'Kaiser Permanente'],
    localInfo: {
      avgCost: '$85-170',
      typicalWaitTime: 'Same day available',
      majorEmployers: ['Apple', 'Google', 'Cisco', 'Adobe', 'PayPal']
    }
  },
